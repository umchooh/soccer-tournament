...
<header class="modal-header bg-dark justify-content-center">
    <div class="page-wrapper">
        <h1 class="text-center">
            <span class="hidden">Soccer's Tournament API</span>
            <a class="nav-link text-white" href="./index.php">Soccer Tournament</a>
        </h1>
